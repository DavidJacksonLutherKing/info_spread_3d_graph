module.exports = {
    generate_tree_by_num: function (num) {
        // $("#generate").click(function () {
        var tree = {};
        var nodeLink = {};
        // var num = $("input[name=number]").val() || 0;
        var fixed_weight_checked = true; //$("input[name=fixed]").prop("checked");
        var fixed_weight = 1000 //$("input[name=fixed-weight]").val();
        nodeLink.nodes = [];
        nodeLink.links = [];
        nodeLink.H5ID = "XXXX";
        for (var i = 0; i < num; i++) {
            var node = {};
            node.customerID = this.getStringRandom(30);
            node.nickName = this.getRandomName(4);
        ...
        // console.log(JSON.stringify(nodeLink));
        return JSON.stringify(nodeLink);
    ...
    getRandomName: function (length) {
        return this.getRandomChineseName() + this.getStringRandom(length);
    }
}